 ...
 * </p>
 * <ul>
 *   <li>{@link LDP.impl.ActiviteImpl#getDescription <em>Description</em>}</li>
...
public class ActiviteImpl extends MinimalEObjectImpl.Container implements Activite {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDPPackage.ACTIVITE__DESCRIPTION, oldDescription, description));
	}
	...
	public NotificationChain basicSetAction(Operation newAction, NotificationChain msgs) {
		...
		action = newAction;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LDPPackage.ACTIVITE__ACTION, oldAction, newAction);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAction(Operation newAction) {
		if (newAction != action) {
			NotificationChain msgs = null;
			if (action != null)
				msgs = ((InternalEObject)action).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LDPPackage.ACTIVITE__ACTION, null, msgs);
			if (newAction != null)
				msgs = ((InternalEObject)newAction).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LDPPackage.ACTIVITE__ACTION, null, msgs);
			msgs = basicSetAction(newAction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDPPackage.ACTIVITE__ACTION, newAction, newAction));
	}

	/**
	 * The cached invocation delegate for the '{@link #pasDansSuivant(LDP.Activite) <em>Pas Dans Suivant</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #pasDansSuivant(LDP.Activite)
	 * @generated
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate PAS_DANS_SUIVANT_ACTIVITE__EINVOCATION_DELEGATE = ((EOperation.Internal)LDPPackage.Literals.ACTIVITE___PAS_DANS_SUIVANT__ACTIVITE).getInvocationDelegate();
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDPPackage.ACTIVITE__DESCRIPTION:
