 ...
 * </p>
 * <ul>
 *   <li>{@link LDPparallel.impl.OperationImpl#getMethodName <em>Method Name</em>}</li>
 *   <li>{@link LDPparallel.impl.OperationImpl#getReturnTag <em>Return Tag</em>}</li>
 *   <li>{@link LDPparallel.impl.OperationImpl#getParamsTag <em>Params Tag</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends MinimalEObjectImpl.Container implements Operation {
	...
	protected EClass eStaticClass() {
		return LDPparallelPackage.Literals.OPERATION;
	}
	...
	public void setMethodName(String newMethodName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDPparallelPackage.OPERATION__METHOD_NAME, oldMethodName, methodName));
	}
	...
	public void setReturnTag(String newReturnTag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LDPparallelPackage.OPERATION__RETURN_TAG, oldReturnTag, returnTag));
	}
	...
	public EList<String> getParamsTag() {
		if (paramsTag == null) {
			paramsTag = new EDataTypeUniqueEList<String>(String.class, this, LDPparallelPackage.OPERATION__PARAMS_TAG);
		}
		return paramsTag;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LDPparallelPackage.OPERATION__METHOD_NAME:
				return getMethodName();
			case LDPparallelPackage.OPERATION__RETURN_TAG:
				return getReturnTag();
			case LDPparallelPackage.OPERATION__PARAMS_TAG:
				return getParamsTag();
		}
